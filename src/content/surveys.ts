...
const founders = {
  ...
  elements: [
    ...
    },
    {
      ...
      description:
        "Please upload your actual P&L, balance sheet, and cash flow statements for the past 24 months in an Excel format (.xlsx, .xls). If S&M, R&D, and G&A do not include payroll and salaries, please provide a payroll and salaries expenses breakdown by each department (S&M, R&D, G&A, etc.).",
      accept: ".xlsx, .xls",
    },
    {
      type: "file",
      ...
      description:
        "Please upload a spreadsheet with sales data by customer for the past 36 months that reconcile to the P&L. The spreadsheet should include the following fields: Date, Client ID/Name, Amount, Currency, and Revenue Stream. Please ensure the data is consistent with the provided P&L statement.",
      accept: ".xlsx, .xls",
    },
    {
      type: "file",
    ...
    },
    {
      ...
      description:
        "Please upload your monthly/quarterly consolidated business plan for the upcoming 4 years (48 months) in an Excel format (.xlsx, .xls). Please ensure the plan is consistent with the historical P&L and cash flow statements provided.",
      accept: ".xlsx, .xls",
    },
    {
      type: "text",
    ...
    },
    {
      ...
      description:
        "Please provide a table including information onthe historical funding rounds - including for each round the raised amount, name of round (A, B, C, etc.), date, pre-money valuation, and main investors participating in each round.",
      accept: ".xlsx, .xls",
    },
    {
      type: "file",
      ...
      description:
        "Please provide the last 2 (or more) audited financial reports.",
      accept: ".pdf",
    },
    {
      type: "text",
      ...
      description:
        "Please provide information on any current debt outstanding, including the type of debt (LOC or term loan), when it was taken, the repayment schedule, interest rate, total facility amount, amounts withdrawn to date, and any liens on the company's assets.",
    },
    {
      type: "text",
      name: "dataRequest9",
      ...
      description:
        "Please provide a full group structure, including the country of incorporation of each entity, and revenue allocations between the entities.",
    },
    {
      type: "text",
      name: "additional1",
      ...
      description:
        "Please provide information on your end customer(s), whether it is B2B (business-to-business), B2C (business-to-consumer), or both.",
    },
    {
      type: "text",
      name: "additional2",
      ...
      description:
        "Please provide information on your business model, including whether it is contractual, subscription-based, or other.",
    },
    {
      type: "text",
      name: "additional3",
      title: "Vertical",
      description:
        "Please provide information on the vertical your company operates in, such as SaaS, e-commerce, or marketplace.",
    },
    {
      type: "text",
      name: "additional4",
      title: "Type",
      description:
        "Please provide information on the type of company you are, such as adtech, fintech, or agtech.",
    },
    {
      type: "text",
      name: "additional5",
      ...
      description:
        "Please provide information on your company's revenue streams.",
    },
    {
      type: "text",
      name: "additional6",
      ...
      description:
        "Please provide information on the geographical markets your company operates in.",
    },
    {
      type: "text",
      name: "netRevenue",
      ...
      description:
        "Please provide information on your company's net revenue or Gross Merchandise Volume (GMV) for the past three years.",
    },
    {
      type: "text",
      name: "takeRate",
      title: "Take Rate",
      description:
        "If your company's revenue is based on GMV, please provide the take rate as a percentage.",
    },
    {
      type: "text",
      name: "growthYoY",
      ...
      description:
        "Please provide information on your company's year-over-year growth rate.",
    },
    {
      type: "text",
      name: "cashBalance",
      title: "Cash Balance",
      description:
        "Please provide information on your company's current cash balance.",
    },
    {
      type: "text",
      ...
      description:
        "Please provide information on your company's monthly burn rate.",
    },
    {
      type: "text",
      name: "totalRunway",
    ...
    },
    {
      ...
      title: "EBITDA Margin",
      description:
        "Please provide information on your company's EBITDA margin.",
    },
    {
      type: "text",
      name: "debt",
    ...
    },
    {
      ...
      description:
        "Alternatively, please provide an invoices file that includes all invoices issued in the past 36 months that reconcile to the financial statements.",
      accept: ".xlsx, .xls",
    },
    {
      type: "file",
      ...
      description:
        "Please provide a consolidated business plan for the upcoming 4 years in an excel spreadsheet.",
      accept: ".xlsx, .xls",
    },
    {
      type: "text",
    ...
    },
    {
      ...
      title: "Historical Funding Rounds",
      description:
        "Please provide a table including information on the historical funding rounds.",
      accept: ".xlsx, .xls",
    },
    {
      type: "file",
    ...
    },
    {
      ...
      title: "Business Model",
      description:
        "Please describe your business model (contractual, subscription, etc.).",
    },
  ],
};
